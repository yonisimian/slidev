    ...
    <div class="flex flex-col items-center gap-6 mt-4">
        ...
        <div class="flex items-start gap-6 pl-24">
            <div class="bg-gray-900 rounded-lg border border-gray-700 overflow-hidden shadow-xl">
                <pre class="px-4 py-3 font-mono text-sm leading-relaxed"><span class="text-[#569cd6]">template</span> <span class="text-[#d4d4d4]">&lt;</span><span class="text-[#4ec9b0]">unsigned</span> <span class="text-[#9cdcfe]">ElementSize</span> <span class="text-[#d4d4d4]">=</span> <span class="text-[#b5cea8]">128</span><span class="text-[#d4d4d4]">&gt;</span>
...
<span class="text-[#d4d4d4]">};</span></pre>
        ...
        <div class="flex flex-col gap-3 items-start">
            <div v-for="(el, idx) in elements" :key="idx" class="flex items-center gap-3 transition-all duration-500">
                <!-- Element header -->
                <div
                ...
                <div class="bg-gray-800 rounded-lg p-2 border border-gray-600 flex gap-1">
                    ...
                    <div v-for="bit in el.bits" :key="bit"
        ...
        <div class="flex gap-8 mt-4 text-sm">
            ...
            <div class="text-gray-400">
                Total bits set: <span class="text-purple-400 font-bold">{{elements.reduce((sum, el) => sum +
                    el.bits.length, 0) }}</span>
            </div>
            <div class="text-gray-400">
