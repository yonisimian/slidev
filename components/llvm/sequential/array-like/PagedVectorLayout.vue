...
<span class="text-[#d4d4d4]">};</span></pre>
        ...
        <div class="flex flex-col items-center mt-4">
            <div class="text-gray-400 text-sm mb-3 font-semibold">Memory Pages (PageSize = {{ pageSize }})</div>

            <div class="flex gap-3">
                <div v-for="pageIdx in numPages" :key="'page-' + pageIdx" class="flex flex-col items-center">
                    <!-- Page label -->
                    ...
                    <!-- Page content -->
                    <div class="flex flex-col border-2 rounded overflow-hidden transition-all duration-500"
                        :class="isPageAllocated(pageIdx - 1) ? 'border-cyan-400 shadow-lg shadow-cyan-900/50' : 'border-gray-600 border-dashed'">
                        <div v-for="i in pageSize" :key="'elem-' + (pageIdx - 1) * pageSize + i"
