...
<span class="text-[#d4d4d4]">};</span></pre>
    ...
    <div class="relative w-full flex justify-center mt-8 -mb-12">
      <div class="relative" :style="{ width: arrayData.length * cellWidth + 'px', height: '80px' }">
        ...
        >
          <div
            class="bg-blue-500 text-white px-3 py-1 rounded font-mono text-sm font-bold shadow-lg"
          >
            data
          </div>
    ...
    <div class="relative w-full flex justify-center">
      <div class="relative">
        ...
        <div
          class="absolute top-0 h-full bg-blue-400/40 border-2 border-blue-400 rounded transition-all duration-700 ease-in-out pointer-events-none"
          :style="{
            left: overlayLeft + 'px',
    ...
    <div class="relative w-full flex justify-center">
      <div class="flex">
        <div
          v-for="(val, idx) in arrayData"
          :key="idx"
          class="text-gray-500 font-mono text-xs text-center"
