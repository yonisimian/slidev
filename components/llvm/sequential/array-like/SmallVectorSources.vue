    ...
    <div class="flex flex-col items-center gap-8 my-8">
        <div class="flex gap-12 items-center">
            <div class="flex flex-col gap-2">
                <div v-for="(ex, idx) in examples" :key="idx"
                    class="px-3 py-1 rounded font-mono text-sm transition-all duration-500" :class="[
                        idx === step
            ...
            <div class="flex flex-col items-center gap-2">
                <div class="bg-green-500 px-6 py-4 rounded-xl font-mono text-lg shadow-lg shadow-green-500/30">
                    SmallVectorImpl&lt;T&gt;
                </div>
