  ...
  <div class="flex flex-col items-center gap-6 mt-4">
    ...
    <div class="flex items-start gap-6 pl-24">
      <div class="bg-gray-900 rounded-lg border border-gray-700 overflow-hidden shadow-xl">
        ...
        ><span class="text-[#569cd6]">class</span> <span class="text-[#4ec9b0]">SmallBitVector</span> <span class="text-[#d4d4d4]">{</span>
...
<span class="text-[#d4d4d4]">};</span></pre>
    ...
    <div class="flex gap-4 items-center">
      <div
        class="px-4 py-2 rounded-full font-bold transition-all duration-500"
        :class="
          isSmallMode
    ...
    <div class="relative w-full flex justify-center">
      ...
      >
        <div v-for="idx in currentSize" :key="idx - 1">
          <!-- Bit value -->
          <div
            class="font-mono text-xs text-center rounded transition-all duration-300"
            :class="
              isBitSet(idx - 1)
          ...
          <!-- Index labels -->
          <div
            class="font-mono text-xs text-center text-gray-500"
