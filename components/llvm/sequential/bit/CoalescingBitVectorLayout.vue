  ...
  <div class="flex flex-col items-center gap-6 mt-4">
    ...
    <div class="flex items-start gap-6 pl-16">
      <div class="bg-gray-900 rounded-lg border border-gray-700 overflow-hidden shadow-xl">
        ...
        ><span class="text-[#569cd6]">template</span> <span class="text-[#d4d4d4]">&lt;</span><span class="text-[#569cd6]">typename</span> <span class="text-[#4ec9b0]">IndexT</span><span class="text-[#d4d4d4]">&gt;</span>
...
<span class="text-[#d4d4d4]">};</span></pre>
    ...
    <div class="flex gap-8 mt-4 text-sm">
      ...
      <div class="text-gray-400">
        find() complexity:
        <span class="text-purple-400 font-bold">O(log {{ intervals.length }})</span>
      </div>
    </div>
  </div>
</template>
