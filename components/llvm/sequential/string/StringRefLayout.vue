  ...
  <div class="flex flex-col items-center gap-6 mt-4">
    ...
    <div class="flex items-start gap-6 pl-32">
      <div class="bg-gray-900 rounded-lg border border-gray-700 overflow-hidden shadow-xl">
        ...
        ><span class="text-[#569cd6]">class</span> <span class="text-[#4ec9b0]">StringRef</span> <span class="text-[#d4d4d4]">{</span>
...
<span class="text-[#d4d4d4]">};</span></pre>
    ...
    <div class="relative w-full flex justify-center -mb-10">
      <div
        class="relative"
        :style="{ width: fullString.length * cellWidth + 'px', height: '60px' }"
      >
        <div
          class="absolute flex flex-col items-center transition-all duration-700 ease-in-out"
          :style="{ left: dataArrowX + 'px', transform: 'translateX(-50%)' }"
        >
          <div
            class="bg-green-500 text-white px-2 py-0.5 rounded font-mono text-xs font-bold shadow-lg"
          >
            Data
          </div>
    ...
    <div class="relative w-full flex justify-center">
      <div class="relative">
        ...
        <div
          class="absolute top-0 h-full bg-green-400/40 border-2 border-green-400 rounded transition-all duration-700 ease-in-out pointer-events-none"
          :style="{
            left: overlayLeft + 'px',
