...
<template>
  <div class="flex flex-col items-center justify-center">
    ...
    <div
      class="mt-6 flex flex-col items-center transition-all duration-500"
    ...
    <div class="mt-8 flex gap-3">
      <div
        v-for="(label, i) in ['Empty', 'Small (5)', 'Inline (13)', 'Heap (40+)']"
        :key="i"
        class="px-3 py-1 rounded text-xs transition-all duration-300"
        :class="phase === i ? 'bg-blue-500 text-white' : 'bg-gray-700 text-gray-400'"
      >
        {{ label }}
      </div>
    </div>
