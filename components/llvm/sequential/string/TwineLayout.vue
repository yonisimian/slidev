<script setup>
  ...
  const animations = [
    ...
    {
      nodes: [{ type: 'concat', left: '"Hello"', right: '", "' }],
      label: '"Hello" + ", "',
    },
    {
      nodes: [
  ...
  <div class="flex flex-col items-center gap-6 mt-4">
    ...
    <div class="flex items-start gap-6 pl-24">
      <div class="bg-gray-900 rounded-lg border border-gray-700 overflow-hidden shadow-xl">
        ...
        ><span class="text-[#569cd6]">class</span> <span class="text-[#4ec9b0]">Twine</span> <span class="text-[#d4d4d4]">{</span>
...
<span class="text-[#d4d4d4]">};</span></pre>
    ...
    <div class="flex flex-col items-center gap-2">
      <!-- Step 0: Single node -->
      <div v-if="step === 0" class="tree-node leaf">"Hello"</div>
      ...
      <div v-if="step === 3" class="tree-node leaf">"Hello"</div>
    </div>
