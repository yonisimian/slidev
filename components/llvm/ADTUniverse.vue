...
const categories = {
    sequential: 'ArrayRef • SmallVector • PagedVector • PackedVector • BitVector • SmallBitVector • SparseBitVector • CoalescingBitVector • StringRef • Twine • SmallString',
...
<template>
    <div>
        ...
        <div class="categories-container">
            ...
            <div class="category-card sequential-card" :class="{
            ...
            <div class="category-card associative-card" :class="{
            ...
            <!-- Miscellaneous -->
            <div class="category-card misc-card" :class="{
