...
<template>
  <div class="flex flex-col items-center justify-center">
    <!-- Title -->
    <div class="text-lg font-bold text-emerald-400 mb-4">Radix Tree - Compressed Prefix Trie</div>
    ...
    <div class="mt-4 flex gap-2">
      <div
        v-for="(label, i) in ['Empty', 'print, scan', '+ printf', '+ println']"
        :key="i"
        class="px-2 py-1 rounded text-xs transition-all duration-300"
        :class="phase === i ? 'bg-emerald-500 text-white' : 'bg-gray-700 text-gray-400'"
      >
        {{ label }}
      </div>
    </div>
