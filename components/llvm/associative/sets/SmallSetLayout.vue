...
<template>
    <div class="flex flex-col items-center justify-center h-full -mt-8">
        ...
        <div class="flex gap-4 mb-4">
            <div class="px-4 py-2 rounded-lg border-2 transition-all duration-300" :class="isInline
        ...
        <div class="flex flex-col items-center mb-6">
            <div class="text-sm text-gray-400 mb-2">Inline Storage ({{ elements.length }}/{{ inlineCapacity }})</div>
        ...
        <div class="mt-6 flex gap-3">
            <div v-for="(label, i) in ['Empty', 'Small (3)', 'Full (8)', 'Overflow (11)']" :key="i"
