...
const getVector = () => {
    ...
    if (phase.value === 2) return [{ id: 1, val: 'foo' }, { id: 2, val: 'bar' }]
    return [{ id: 1, val: 'foo' }, { id: 2, val: 'bar' }] // "foo" already has ID 1
}
...
<template>
    <div class="flex flex-col items-center justify-center">
        ...
        <div class="flex gap-12 items-start">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="flex flex-col gap-1">
                    <div v-for="item in getVector()" :key="item.id"
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="flex flex-col gap-1">
                    <div v-for="(id, key) in getMap()" :key="key"
                        class="flex items-center gap-2 transition-all duration-300">
                        <div
        ...
        <div class="mt-6 flex gap-2">
            <div v-for="(label, i) in ['Empty', 'insert foo → 1', 'insert bar → 2', 'insert foo → 1']"
                :key="i" class="px-2 py-1 rounded text-xs transition-all duration-300" :class="phase === i
