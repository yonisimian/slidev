...
<template>
    <div class="flex flex-col items-center justify-center h-full -mt-6">
        <!-- Title -->
        <div class="text-lg font-bold text-violet-400 mb-4">
            ImmutableSet - Persistent AVL Tree
        </div>
        ...
        <div class="flex gap-8 items-end">
            ...
            <div v-if="phase >= 2" class="flex flex-col items-center transition-all duration-500">
                ...
                <div class="relative w-32 h-24">
                    ...
                    <!-- Lines -->
                    <svg class="absolute inset-0 w-full h-full" style="z-index: -1">
                        <line x1="64" y1="28" x2="24" y2="48" stroke="#8b5cf6" stroke-width="2" stroke-dasharray="4" />
        ...
        <div class="mt-4 flex gap-2">
            <div v-for="(label, i) in ['Concept', 'Create S1', 'Add 9 → S2']" :key="i"
